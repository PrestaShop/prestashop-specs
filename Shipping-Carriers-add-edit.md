...
Related Bug to fix -> https://github.com/PrestaShop/PrestaShop/issues/15214
...
When you enable several zone en type in a price in the “All” is set this price to the enabled zones.

Improvement for the migration :
When free shipping is set to “YES”, all fields below the Free Shipping field are hidden.
The ranges table is simplified and only displayed zone to enable/disable for the carrier.
...
Add new: All groups are enabled (boxes are checked).
