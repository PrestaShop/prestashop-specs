...
If you click on it, the thread is opened (view page) and all the messages notifications are removed for the current employee.
...
The language selected by the customer in the front office or the employee in the back office (through an order message) while sending the message is displayed.
