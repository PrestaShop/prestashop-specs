...
- View %x% errors - Button - Opens the Errors log. %x% is the number of errors
    - Errors log - Lists in the modal all the error messages in a warning-alert
...
| --- | --- | --- |
| No | Yes | The modal is closed and it displays an alert-success |
| No | No | It displays an alert-success |
