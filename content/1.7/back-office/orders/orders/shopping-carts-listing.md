...
- **Shop** - filtering is not available, but the whole column is filled up with the Shop names for each Shopping Cart, if there are several multistores configured.
